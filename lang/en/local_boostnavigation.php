...
$string['mycoursesrootnodesfilterhintenabledcurrentfilter'] = 'Current course filter:';
$string['mycoursesrootnodesfilterhintenabledcourselist'] = 'Course list filtered by:';
$string['mycoursesrootnodesfilterlink'] = 'Change filter';
...
$string['setting_modifymycoursesrootnodesfilterhint'] = 'Add course filter hint node';
$string['setting_modifymycoursesrootnodesfilterhint_desc'] = 'Enabling this setting will add a node to the end of the My courses list in Boost\'s nav drawer telling the user why the My courses list is filled as it is (i.e. which course filter produced the current My courses list).';
$string['setting_modifymycoursesrootnodesfilterlink'] = 'Add course filter link node';
$string['setting_modifymycoursesrootnodesfilterlink_desc'] = 'Enabling this setting will add a node to the end of the My courses list in Boost\'s nav drawer telling the user where to change the current course filter.<br /><em>This setting is associated to the "Add course filter hint node" setting. If you enable both settings, then a combined node will be added instead of two.</em>';
$string['setting_modifymycoursesrootnodesshowfiltered'] = 'Show filtered courses';
$string['setting_modifymycoursesrootnodesshowfiltered_desc'] = 'Enabling this setting will change the My courses list in Boost\'s nav drawer to show the courses which are currently filtered in the Course overview block instead of simply showing courses which are classified as \'In progress\'.';
...
$string['settingspage_mycoursesrootnodes'] = 'My courses root nodes';
